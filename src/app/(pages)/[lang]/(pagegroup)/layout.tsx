          ...
          <TanstackProvider>
            <ModalProvider>
              <UserProvider>
                ...
                <PageViewDataLayer />
                <HeaderWrapper lang={lang} variant={HeaderVariants.Default}>
                  <Header lang={lang} />
                </HeaderWrapper>
                <HeaderMobile lang={lang} variant={HeaderVariants.Default} />
                <div className="pt-[63px] md:pt-[84px]">{children}</div>
                <Footer lang={lang} />
                {process.env.NEXT_PUBLIC_ENVIRONMENT !== 'development' && (
